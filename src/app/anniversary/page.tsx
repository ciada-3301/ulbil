...
export const metadata = {
  title: "125th Quasquicentennial Jubilee (1902â€“2027)",
...
export default function AnniversaryPage() {
  return (
    <div className="py-12 space-y-16">
      ...
      {/* 1. Header Banner with Official Jubilee Logo */}
      ...
      <section className="max-w-6xl mx-auto px-4 sm:px-8">
        <div className="text-center max-w-3xl mx-auto mb-10">
          <span className="text-sm font-bold uppercase tracking-widest text-[#D95D24] bg-[#FEF0EA] px-3.5 py-1 rounded-full border border-[#B8860B]/50">
            Historical Progression
          </span>
          <h2 className="font-serif font-extrabold text-2xl sm:text-4xl text-[#2C2420] mt-3">
            The 125-Year Journey (1902â€“Present)
          </h2>
          <p className="text-sm sm:text-base text-[#6B635D] mt-2">
      ...
      <section className="bg-[#FAF7F0] border-y border-[#E8E0D4] py-16">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            ...
            <div className="lg:col-span-7 space-y-4">
              ...
              <p className="text-sm sm:text-base text-[#6B635D] leading-relaxed">
                Featuring handwritten letters from eminent historians, rare archival photographs of Uluberia from 1902â€“1950, articles on Bengal literature, and personal memoirs by our longest-serving patrons and teachers.
              </p>

              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-2">
                <div className="p-3.5 rounded-xl bg-white border border-[#E8E0D4] text-sm space-y-1">
                  <div className="font-bold text-[#2C2420] flex items-center gap-1">
                    <BookOpen className="w-4 h-4 text-[#D95D24]" />
                    <span>Hardbound Jubilee Volume</span>
                  </div>
                  <p className="text-[11px] text-[#9A918A]">250+ Pages with rare manuscript plates & essays.</p>
                </div>
                ...
                <div className="p-3.5 rounded-xl bg-white border border-[#E8E0D4] text-sm space-y-1">
                  ...
                  <p className="text-[11px] text-[#9A918A]">Available for free scholarly reading & download.</p>
                </div>
              </div>

              <div className="pt-2">
                <a
                  href="/home/Publications.pdf"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 px-5 py-3 rounded-xl text-sm font-bold text-white bg-[#D95D24] hover:opacity-95 shadow-sm transition-all"
                >
            ...
            <div className="lg:col-span-5 flex justify-center">
              <div className="p-8 rounded-2xl bg-white border-2 border-[#B8860B] shadow-md text-center max-w-sm w-full space-y-4">
                <div className="w-20 h-20 mx-auto rounded-2xl bg-[#FEF0EA] border border-[#B8860B]/60 flex items-center justify-center text-[#D95D24]">
                  <Award className="w-10 h-10" />
                </div>
                <div>
                  <h3 className="font-serif font-bold text-lg text-[#2C2420]">125th Souvenir Volume</h3>
                  <p className="text-sm text-[#B8860B] font-semibold">Uluberia Institute & Library Editorial Council</p>
                </div>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-8">
        <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-8">
          ...
          <Link
            href="/gallery"
            className="text-sm font-bold text-[#D95D24] hover:text-[#D95D24] flex items-center gap-1"
          >
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {GALLERY_SLIDES.slice(0, 4).map((slide) => (
            <div key={slide.id} className="heritage-card rounded-2xl overflow-hidden bg-white border border-[#E8E0D4] group">
              ...
              <div className="p-3">
                <span className="text-[10px] font-bold text-[#B8860B] uppercase tracking-wider">{slide.year}</span>
                <h4 className="font-serif font-bold text-sm text-[#2C2420] line-clamp-1 mt-0.5">{slide.title}</h4>
              </div>
            </div>
          ))}
        </div>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-8">
        <div className="text-center max-w-3xl mx-auto mb-10">
          ...
          <p className="text-sm sm:text-base text-[#6B635D] mt-1">
